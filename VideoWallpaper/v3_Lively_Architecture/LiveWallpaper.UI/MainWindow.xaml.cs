...
namespace LiveWallpaper.UI
{
    public partial class MainWindow : FluentWindow
    {
        ...
        private void AutoStartSwitch_Checked(object sender, RoutedEventArgs e)
        {
            ...
            string engineExe = Path.Combine(AppContext.BaseDirectory, "LiveWallpaper.Engine.exe");
        ...
        private void Exit_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var proc in System.Diagnostics.Process.GetProcessesByName("LiveWallpaper.Engine"))
            {
                try { proc.Kill(); } catch { }
            }
